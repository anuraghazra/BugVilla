...
router.get('/:bugId/comments/:comment_id/reactions', CommentsController.getReactions);
router.patch('/:bugId/comments/:comment_id/reactions', CommentsController.addOrRemoveReaction);
